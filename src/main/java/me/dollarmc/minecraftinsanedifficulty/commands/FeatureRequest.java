...
public class FeatureRequest implements CommandExecutor {

    private static final Logger LOGGER = LogManager.getLogger(FeatureRequest.class);
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        try {
            ...
            issue.setBody(body);
            List<Label> labels = Arrays.asList(new Label().setName("enhancement"));
